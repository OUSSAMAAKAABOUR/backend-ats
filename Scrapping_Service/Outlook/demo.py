...
folder_path = os.path.join(base_dir, 'Attachments')
folder_path_temp = os.path.join(base_dir, 'Temporary_Attachments')
...
def download_email_attachments(message_id, headers, save_folder=os.getcwd()):
    ...
    try:
        ...
        for attachment in attachment_items:
            ...
            # save the same file name into temp dir
            with open(os.path.join(folder_path_temp, unique_filename), 'wb') as _f:
                _f.write(attachment_content.content)
...
def handle_Scrapping(sujet, id_internship):
    ...
    # folder_path = 'C:/Users/pc/Desktop/Stage_PULSE/codes/ATS-PROJECT/ATS_PROJECT/ATS_Project/Scrapping_Service/Attachments'
    # folder_path_temp = 'C:/Users/pc/Desktop/Stage_PULSE/codes/ATS-PROJECT/ATS_PROJECT/ATS_Project/Scrapping_Service/Temporary_Attachments'
    
    # base_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    # folder_path = os.path.join(base_dir, 'Attachments')
    # print(f"attachments path: {folder_path}")

    # folder_path_temp = os.path.join(base_dir, 'Temporary_Attachments')
    # print(f"attachments temp path: {folder_path_temp}")
    ...
    if os.listdir(folder_path_temp):
        ...
        for filename in os.listdir(folder_path_temp):
            if filename.endswith('.pdf'):  
                ...
                reference = 'Attachments/' + str(filename)
